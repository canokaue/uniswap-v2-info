...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://dex.mintyswap.com/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://dex.mintyswap.com/#/swap?inputCurrency=${
...
export function getMiningPoolLink(token0Address) {
  return `https://dex.mintyswap.com/#/minty/ETH/${token0Address}`
}

export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://dex.mintyswap.com/#/minty'
  if (!linkVariable) {
